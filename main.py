...
class GuessNumberWidget(FloatLayout):
    def __init__(self, **kwargs):
        ...
        # Основная игровая карточка с увеличенными отступами
        self.game_card = DarkCard(
            orientation='vertical',
            padding=[dp(20), dp(40)],  # Увеличили вертикальный отступ для текста сверху
            spacing=dp(15),
            size_hint=(0.9, None),  # Убрали фиксированную высоту, адаптируем под содержимое
            height=dp(600) if self.screen_height > 800 else dp(500),  # Динамическая высота
    ...
    def update_adaptive_sizes(self):
        ...
        self.game_card.height = dp(600) if self.screen_height > 800 else dp(500)
